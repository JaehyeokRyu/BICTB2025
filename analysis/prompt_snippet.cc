...
int main(int argc, char *argv[])
{
  ...
  TBcid cid_M11_T1_S = util.GetCID("C1");
  TBcid cid_M1_T4_C = util.GetCID("C2");


  // prepare the histograms wa want to draw
  TH1F* hist_M11_T1_S = new TH1F("C1", ";intADC;nEvents", 4400, -4000, 40000);
  TH1F* hist_M1_T4_C  = new TH1F("C2",  ";intADC;nEvents", 4400, -4000, 40000);
  ...
  TBread<TBwaveform> readerWave = TBread<TBwaveform>(fRunNum, fMaxEvent, fMaxFile, false, "/home/jryu/EIC/Data", {8, 11, 17});
